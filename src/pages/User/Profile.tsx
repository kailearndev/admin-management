            ...
            <div className="w-full flex flex-col sm:grid sm:grid-cols-3 xl:flex xl:flex-col gap-3 xl:gap-5">
              ...
              <div className="w-full grid xl:grid-cols-3 2xl:grid-cols-4 items-center gap-1 xl:gap-0">
                ...
                <img
                  ...
                  className="cursor-pointer w-40  h-40  aspect-square rounded-lg shadow-xl dark:shadow-gray-800" src={formik.values?.urlHelloPicture} alt="image description" />
                ...
                <div className='flex flex-col gap-2 justify-center  items-center w-full'>
                  ...
                  <div className="carousel rounded-box w-96 ">
                    ...
                    {formik.values.skills.map((item) => (
                      ...
                      <div key={item.order} className=" carousel-item w-full" >
                        <button className="btn  w-full">
                          {item.name}
                          <div className="badge badge-accent">{item.star}</div>
                  ...
                  <div className='text-center animate-pulse'>Scroll to see</div>
                </div>
              </div>
            </div>
            {/* column 2 */}
